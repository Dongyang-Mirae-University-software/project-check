...
| project-check | 예 | MySQL, PostgreSQL, MongoDB, Redis, SQLite, MSSQL, Oracle | 실행 중 | 1433, 1521, 3000, 3099, 3306, 4000, 4306, 4747, 5432, 6015, 6017, 6018, 6019, 6379, 6501, 6511, 8000, 8010, 8080, 11001, 11002, 11004, 14122, 26214, 27017 | 확인 불가 |
...
- project-check: MySQL, PostgreSQL, MongoDB, Redis, SQLite, MSSQL, Oracle 사용 추정
  - 근거: docker-compose.yml 확인, requirements.txt 확인, package.json 확인, .env 키 156개 확인, 추정 DB: MySQL, PostgreSQL, MongoDB, Redis, SQLite, MSSQL, Oracle
